...
double precision :: rho0_s  = 1895.d0
NAMELIST/material_pbx9502rtt_params/ a_s, b_s, gamma_s, cv_s, r1_s, &
                                r2_s, rho0_s

!-------Products
double precision :: a_g     = 13.6177e11
double precision :: b_g     = 0.7199e11
double precision :: r1_g    = 6.2d0
double precision :: r2_g    = 2.2d0
double precision :: gamma_g = 0.5d0
double precision :: cv_g    = 1.0e6
double precision :: rho0_g  = 1895.d0
double precision :: q_ref   = 0.069e11  
NAMELIST/material_pbx9502pdt_params/ a_g, b_g, gamma_g, cv_g, r1_g, &
r2_g, q_ref

!-------Reaction
double precision :: i_r         = 4.0e12
double precision :: lambda_i_r  = 0.025d0
double precision :: a_r         = 0.214d0
double precision :: b_r         = 0.667d0
double precision :: x_r         = 7.0d0
double precision :: g1_r        = 4613.0e6
...
NAMELIST/material_pbx9502rtn_params/ i_r, a_r, b_r, x_r, c_r,  &
...
contains
subroutine write_material_pbx9502_inp(funit)
    implicit none
    integer,intent(in) :: funit
    write(funit,NML=material_pbx9502rtt_params)
    write(funit,NML=material_pbx9502pdt_params)
    write(funit,NML=material_pbx9502rtn_params)
end subroutine write_material_pbx9502_inp

subroutine initial_material_pbx9502(funit)
    implicit none
    integer,intent(in) :: funit
    if(.not.if_initialized) then
        read(funit,NML=material_pbx9502rtt_params)
    read(funit,NML=material_pbx9502pdt_params)
    read(funit,NML=material_pbx9502rtn_params)
  endif
end subroutine initial_material_pbx9502

subroutine scale_material_pbx9502(rho_rv,u_rv,temp_rv,time_rv, &
...
end subroutine scale_material_pbx9502

subroutine compute_pref_mixt1_pbx9502(p_ref,rho_s,rho_g,lbd)
    implicit none
...
end subroutine compute_pref_mixt1_pbx9502

subroutine compute_pref_mixt2_pbx9502(p_ref,dp_ref,rho_s,rho_g,lbd,drho_s,drho_g)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd 
...
end subroutine compute_pref_mixt2_pbx9502

subroutine compute_eref_mixt1_pbx9502(ei_ref,rho_s,rho_g,lbd)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd 
...
end subroutine compute_eref_mixt1_pbx9502

subroutine compute_eref_mixt2_pbx9502(ei_ref,dei_ref,rho_s,rho_g,lbd,drho_s,drho_g)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd 
    double precision,intent(in) :: drho_s,drho_g
...
end subroutine compute_eref_mixt2_pbx9502

subroutine compute_rhogamma_mixt1_pbx9502(rhogamma_mixt,rho_s,rho_g,lbd)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd
...
end subroutine compute_rhogamma_mixt1_pbx9502

subroutine compute_rhogamma_mixt2_pbx9502(rhogamma_mixt,drhogamma_mixt,rho_s,rho_g,lbd,drho_s,drho_g)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd
    double precision,intent(in) :: drho_s,drho_g
...
end subroutine compute_rhogamma_mixt2_pbx9502

subroutine compute_pressure_mixt1_pbx9502(p,e,rho_s,rho_g,lbd)
    implicit none
...
end subroutine compute_pressure_mixt1_pbx9502

subroutine compute_pressure_mixt2_pbx9502(p,rho_s,rho_g,lbd)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd
    double precision,intent(inout) :: p 
    ...
    p = numerator/denominator
end subroutine compute_pressure_mixt2_pbx9502

subroutine compute_pressure_mixt3_pbx9502(p,numerator,denominator,rho_s,rho_g,lbd)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd
    ...
    denominator = rgcv_s - rgcv_g
    p = numerator/denominator
end subroutine compute_pressure_mixt3_pbx9502

subroutine compute_pressure_mixt4_pbx9502(num,dom,dnum,ddom,rho_s,rho_g,lbd,drho_s,drho_g)
    implicit none
    double precision,intent(in) :: rho_s,rho_g,lbd
    double precision,intent(in) :: drho_s,drho_g
...
end subroutine compute_pressure_mixt4_pbx9502

! compute the internal energy of reactant
subroutine compute_ei_reac_pbx9502(ei,p,r)
    implicit none
...
end subroutine compute_ei_reac_pbx9502

! compute the internal energy of product
subroutine compute_ei_prod_pbx9502(ei,p,r)
    implicit none
    double precision,intent(in) :: p,r 
    double precision,intent(inout) :: ei 
...
end subroutine compute_ei_prod_pbx9502

! compute the internal energy of the mixture
subroutine compute_internal_energy_mixt_pbx9502(ei,eia,eib,p,ra,rb,lbd)
    implicit none
    double precision,intent(in) :: p,ra,rb,lbd
    double precision,intent(inout) :: ei,eia,eib 
    double precision :: p_ref, ei_ref
    call compute_ei_reac_pbx9502(eia,p,ra)
    call compute_ei_prod_pbx9502(eib,p,rb)
    ei = (1.d0-lbd)*eia+lbd*eib
end subroutine compute_internal_energy_mixt_pbx9502    

! compute the sound speed of mixture
subroutine compute_sound_speed2_pbx9502(c2,p,rho,rho_s,rho_g,lambda)
    implicit none
...
end subroutine compute_sound_speed2_pbx9502

subroutine compute_xi_pbx9502(xi,r,ra,rb,lbd)
    implicit none
    ...
    xi = 1.d0/(gg - 1.d0)
end subroutine compute_xi_pbx9502

subroutine compute_temperature_mixt_pbx9502(t,cv,p,rho_s,rho_g,lbd)
    implicit none
...
end subroutine compute_temperature_mixt_pbx9502

! compute the reaction rate of IG model
subroutine compute_source_pbx9502(src0, src_num,                     &
    ...
    rho = phs_prim(2)
    lbd = phs_cpnt_prim(3)
    call heaviside_pbx9502(hv,rho/rho0_s-1.d0-a_r)
    call heaviside_pbx9502(hp,p)
    call heaviside_pbx9502(h0,lambda_i_r-lbd)
    call heaviside_pbx9502(h1,lambda_g1_r-lbd)
    call heaviside_pbx9502(h2,lbd-lambda_g2_r)
    ...
    src0(1) = z*src0(1)*rho
end subroutine compute_source_pbx9502

subroutine heaviside_pbx9502(h,x)
    implicit none
...
end subroutine heaviside_pbx9502
end module
